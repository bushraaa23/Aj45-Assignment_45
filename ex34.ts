...
// print only names of pizzza

//for (let i = 0; < myPizza.length; i++) {
...
//}
 ...
 //console.log(
    //`\nI really like to eat Pizzas. Pizza comes in a variable of 
    //flavors and toopings, allowing individuals to customize it to their liking`);
